...
async function main() {
    ...
    july31.forEach((e, idx) => {
        ...
        if (displayJournalId === 'JU26073118') {
             ...
             console.log("refType:", e.refType);
             console.log("refId:", e.refId);
             console.log("lines:", JSON.stringify(e.lines, null, 2));
             console.log("amount:", e.amount);
        }
    });

    console.log("Total entries on 260731:", july31.length);
    process.exit(0);
}
