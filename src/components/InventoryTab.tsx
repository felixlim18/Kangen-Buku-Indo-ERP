...
export const InventoryTab: React.FC = () => {
  ...
  // Semua koleksi dalam satu objek untuk mesin perhitungan. Identitasnya berubah
  // hanya saat data benar-benar berubah, sehingga memo di bawah tidak thrashing.
  const perpetualData: PerpetualData = React.useMemo(() => ({
